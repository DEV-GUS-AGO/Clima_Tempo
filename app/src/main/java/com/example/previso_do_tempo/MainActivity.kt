...
import com.example.previso_do_tempo.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun fetachWeatherData(cityName:String) {
        ...
        val response = retrofit.getWeatherData(cityName, "", "metric")
    ...
    private fun changeImage(conditions: String) {
        when(conditions){
            ...
            "Fog", "Light Snow", "Moderate Snow", "Heavy Snow", "Blizzard" -> {
